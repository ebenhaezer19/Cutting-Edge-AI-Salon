    ...
    <section id="payment" className="py-16 bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">Simple & Secure Payments</h2>
            ...
            <div className="flex flex-col items-center justify-center gap-8">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Scan, pay, and go! We accept all QRIS-enabled payment methods for your convenience.
                </p>
                <Button
                  variant="primary"
                ...
                {!selectedService && (
                  <p className="text-sm text-red-500 mt-2">
                    Silakan pilih layanan terlebih dahulu di bagian Our Services
                  </p>
                )}
              </div>
            ...
            {!paymentSimulation ? (
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Scan this QRIS code using your preferred payment app
                </p>
              </div>
            ) : (
              <div className="text-center">
